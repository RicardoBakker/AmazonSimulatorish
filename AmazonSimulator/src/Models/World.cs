...
namespace Models
{
  public class World : IObservable<Command>, IUpdatable
  {
    ...
    {
      Truck t = new Truck(x, y, z, 0, (90 * Math.PI / 180), 0);
      worldObjects.Add(t);
      return t;
    }
    ...
    {
      r.ChangeRobotDropped(false);
      List<string> path = FindRoute(begin, end);
      r.GetPath(r.target, path, iList, xList, zList);
    }
